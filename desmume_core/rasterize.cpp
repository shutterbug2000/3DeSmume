...
public:
	...
	FORCEINLINE void pixel(int adr,float r, float g, float b, float invu, float invv, float w, float z)
	{
		...
		shader.materialColor.r = fmax(0U,fmin(63U,u32floor(r)));
		shader.materialColor.g = fmax(0U,fmin(63U,u32floor(g)));
		shader.materialColor.b = fmax(0U,fmin(63U,u32floor(b)));
